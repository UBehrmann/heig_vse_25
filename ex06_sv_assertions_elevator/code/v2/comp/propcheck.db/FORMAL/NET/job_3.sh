...
/opt/mentor/questaformal/${ZI_PLATFORM}/bin/qverifypm --monitor --host reds-vmeda --port 41309 --wd /media/sf_share_folder/vse/heig_vse_25/ex06_sv_assertions_elevator/code/v2/comp --type slave --binary /opt/mentor/questaformal/${ZI_PLATFORM}/bin/qverifyfk --id 3 -netcache /media/sf_share_folder/vse/heig_vse_25/ex06_sv_assertions_elevator/code/v2/comp/propcheck.db/FORMAL/NET -tool prove -auto_constraint_off -hd .qverify -import_db ./propcheck.db/formal_compile.db -slave_mode -mpiport reds-vmeda:34579 -slave_id 3 
